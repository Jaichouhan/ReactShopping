    ...
    <>
      <div className="container">
        <div className="terms-page-wrapper">
          ...
          <h3>Log Files</h3>
          <p>
            follows a standard procedure of using log
          ...
          <p>
            Like any other website,  uses 'cookies'.
          ...
          <p>
            Note that  has no access to or control over
            these cookies that are used by third-party advertisers.
          </p>
          <h3>Third Party Privacy Policies</h3>
          <p>
            Privacy Policy does not apply to other
          ...
          <p>
           does not knowingly collect any Personal
